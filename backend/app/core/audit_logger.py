...
class AuditAction(str, Enum):
    ...
    PATIENT_EMAIL_VERIFICATION_SENT = "PATIENT_EMAIL_VERIFICATION_SENT"
    PATIENT_EMAIL_VERIFIED = "PATIENT_EMAIL_VERIFIED"
    PATIENT_EMAIL_VERIFICATION_FAILED = "PATIENT_EMAIL_VERIFICATION_FAILED"
    PATIENT_EMAIL_VERIFICATION_EXPIRED = "PATIENT_EMAIL_VERIFICATION_EXPIRED"
    OPD_ASSIGNMENT = "OPD_ASSIGNMENT"
