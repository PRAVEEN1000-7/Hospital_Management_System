...
async def get_optical_prescription_pdf(
    ...
    # Machine Prescribed is intentionally left out of this printed/downloaded
    # Rx — the patient-facing document shows only the doctor's final call,
    # not the auto-refractometer's raw reading. It still shows on the
    # on-screen prescription detail page (a separate React component), just
    # not here.
    html = f"""<!DOCTYPE html>
<html lang="en">
<head>
