...
class PatientBase(BaseModel):
    ...
    known_allergies: Optional[str] = Field(None, max_length=1000, description="Known allergies (comma-separated)")
    chronic_conditions: Optional[str] = Field(None, max_length=1000, description="Chronic conditions / medical history")
