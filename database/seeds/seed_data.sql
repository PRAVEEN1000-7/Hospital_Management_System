...
-- ⚠️  SECURITY: This file contains bcrypt-hashed passwords for DEV/TEST only.
--     Change ALL passwords immediately in production via the application UI.
--     Default credentials are documented in TESTING_GUIDE.md (not committed to repo).

-- Create default users (passwords are bcrypt-hashed, rounds=12)
