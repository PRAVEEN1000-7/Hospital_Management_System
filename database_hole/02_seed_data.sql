...
--    Password: "Admin@123" â†’ bcrypt hash below
--    Reference numbers: 12-digit HMS IDs
-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- bcrypt hash for "Admin@123" (verified working with Python bcrypt library):
-- $2b$12$Zc/t6qC3PAhEUFuIhUw48Ot5q2kzGlxXtJhOdVF4NDxS1oI6ZVsXa
...
VALUES
    ...
    -- Doctor1 — Quick-access doctor account (username: doctor1, password: doc@123)
    -- bcrypt hash for "doc@123":
    ('10000000-0000-0000-0000-000000000099', 'a0000000-0000-0000-0000-000000000001',
     'HCD261X00099',
     'doctor1@hmscore.com', 'doctor1',
     '$2b$12$vhZ0fjiDdU/7eM8QJA86AOUu9VIewmj57agmV2GLe9pzTIkHg/BgO',
     'Doctor', 'One', '+12125550099', true, false);
...
VALUES
    ...
    ('10000000-0000-0000-0000-000000000099', 'e0000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001'); -- Doctor1
...
VALUES
    ...
    -- Doctor1 profile
    ('20000000-0000-0000-0000-000000000099', '10000000-0000-0000-0000-000000000099', 'a0000000-0000-0000-0000-000000000001',
     'c0000000-0000-0000-0000-000000000001', 'General Medicine', 'MBBS, MD', 'MED-NY-10099', 'NY State Medical Board', 10,
     150.00, 75.00, 99, '10000000-0000-0000-0000-000000000001');
...
VALUES
    -- Dr. Smith (General Medicine) â€” Mon-Fri
    ...
    -- Dr. Lee (Ophthalmology) â€” Mon-Fri
...
VALUES
    ('40000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',
     'APT-20260215-072DC6', '30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
    ...
    ('40000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001',
     'APT-20260215-8CFAE9', '30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002',
    ...
    ('40000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001',
     'APT-20260216-9F4159', '30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003',
    ...
    ('40000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001',
     'APT-20260222-C58E2C', '30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
    ...
    ('40000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001',
     'WLK-20260216-6A5090', '30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000001',
...
VALUES
    ...
    ('a0000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000006', 'create', 'appointment', '40000000-0000-0000-0000-000000000001', 'APT-20260215-072DC6', '192.168.1.101', '/api/v1/appointments'),
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- Summary:
--   â€¢ 3 hospitals (HMS Core, Apollo, Max)
--   â€¢ 3 hospital settings
--   â€¢ 10 departments (HMS Core)
--   â€¢ 5 tax configurations
--   â€¢ 9 system roles
--   â€¢ 37 permissions
--   â€¢ Role-permission mappings for all 9 roles
--   â€¢ 10 users (super admin + admin + 3 doctors + receptionist + pharmacist + cashier + optical + inventory)
--   â€¢ 3 doctors with schedules and fees
--   â€¢ 5 patients
--   â€¢ 5 appointments (3 completed, 2 scheduled)
--   â€¢ 3 prescriptions with items
--   â€¢ 10 medicines with batches
--   â€¢ 3 invoices with items and payments
--   â€¢ 7 optical products
--   â€¢ 3 suppliers
--   â€¢ 3 insurance providers
--   â€¢ 5 notification templates
--   â€¢ ID sequences
--   â€¢ Sample audit logs
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
