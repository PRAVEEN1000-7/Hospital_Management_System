...
import NewGeneralBilling from './pages/NewGeneralBilling';
    ...
    >
      ...
      <Routes>
            ...
            >
              ...
              <Route path="/billing/general-billing" element={
                <ProtectedRoute
                  allowedRoles={allowedRoles('general_billing')}
                  requiredModule="general_billing"
                >
                  <NewGeneralBilling />
                </ProtectedRoute>
              } />
