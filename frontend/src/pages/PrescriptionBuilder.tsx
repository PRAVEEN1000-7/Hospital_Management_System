        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {patient && (
            <div className="rounded-xl border-2 border-indigo-300 shadow-lg overflow-hidden ring-2 ring-indigo-100 bg-gradient-to-br from-indigo-50/60 via-white to-indigo-50/40">
              {/* ═══ ALLERGY ALERT BANNER ═══ Highly visible red banner to warn prescribers */}
              ...
              {/* ═══ MEDICAL HISTORY SECTION ═══ Highlighted patient history for quick review */}
              <div className="px-6 py-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Chronic Conditions — highlighted with amber border */}
                  ...
                  {/* Known Allergies (detailed card view) — red-highlighted for visibility */}
                ...
                {/* Patient Quick Info — highlighted summary card */}
          ...
          {blocks.slice(0, 1).map((block, blockIdx) => (
            <div key={block.id} className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-visible">
              ...
              <div className="px-6 pb-5 space-y-4">
                ...
                {/* Medicines Table — all medicines in one compact grid */}
                <div>
