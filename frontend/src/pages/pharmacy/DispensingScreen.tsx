      ...
      try {
        ...
        const items: DispensingItem[] = rx.items.map((item) => {
          ...
          return {
            ...
            dispensedQty: hasStock ? item.quantity : 0,
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              {dispensingItems.map((item, index) => {
                ...
                const isPartial = item.dispensedQty < item.quantity && item.dispensedQty > 0;
                const isOutOfStock = item.available_quantity === 0;
                        ...
                        <div>
                          ...
                          {isPartial && (
                            <div className="text-xs text-orange-600 mt-1 flex items-center gap-1">
                              ...
                              Partial: {item.quantity - item.dispensedQty} units short
                            </div>
                          )}
                        </div>
                      </div>
