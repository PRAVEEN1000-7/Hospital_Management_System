...
import { Users, UserPlus, Activity, Shield, Settings, Building2 } from 'lucide-react';
...
export const Dashboard: React.FC = () => {
  ...
  // Add Hospital Profile card for admin and super_admin
  if (user?.role === 'admin' || user?.role === 'super_admin') {
    cards.push({
      title: 'Hospital Profile',
      description: 'Configure hospital information',
      icon: Building2,
      color: 'bg-indigo-500',
      action: () => navigate('/hospital-profile'),
    });
  }
